...
final readonly class MarkAsNoShow
{
    ...
    public function execute(string $reservationId, string $noShowBy): ReservationDTO
    {
        ...
        $reservation->markAsNoShow(Uuid::fromString($noShowBy));
