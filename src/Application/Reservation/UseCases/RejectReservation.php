...
final readonly class RejectReservation
{
    ...
    public function execute(RejectReservationDTO $dto): ReservationDTO
    {
        ...
        $reservation->reject(Uuid::fromString($dto->rejectedBy), $dto->rejectionReason);
